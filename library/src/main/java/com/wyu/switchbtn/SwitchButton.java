...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkedColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_checked_background_color,
        ...
        checkLineColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_checked_line_color,
                Color.WHITE);//Color.WHITE;

        checkLineWidth = optPixelSize(typedArray,
                R.styleable.SwitchButton_sb_checked_line_width,
        ...
        uncheckButtonColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_uncheck_button_color,
                buttonColor);

        checkedButtonColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_checked_button_color,
                buttonColor);
        ...
        isChecked = optBoolean(typedArray,
                R.styleable.SwitchButton_android_checked,
                false);
        ...
        background = optColor(typedArray,
                R.styleable.SwitchButton_android_background,
                Color.WHITE);//Color.WHITE;
